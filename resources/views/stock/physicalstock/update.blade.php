...
@section('title', 'Physical Stock Update | '.$seo->meta_title)
@section('content')
@php
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="offset-lg-1 col-lg-10">
                <div class="card m-0">
                    <div class="card-header d-flex justify-content-between bg-header">
                        <div class="header-title">
                            <h4 class="card-title">Physical Stock Update</h4>
                        </div>
                ...
                <form action="{{route('admin.physicalstock.update')}}" method="POST" enctype='multipart/form-data'>
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="invoice_no" name="invoice_no" id="invoice_no" value="{{ $edit->invoice_no }}" />
                                                <datalist id="brow">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="narration" class="form-control">{{$edit->narration}}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="fname">Number Of Item:</label>
                                                                <input type="text" class="form-control number_of_item" disabled value="{{ $edit->num_of_item }}">
                                                                <input type="hidden" name="num_of_item" class="form-control number_of_item" value="{{ $edit->num_of_item }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="fname">Number Of Qty:</label>
                                                                <input type="text" class="form-control number_of_qty" disabled value="{{ $edit->num_of_item }}">
                                                                <input type="hidden" name="num_of_qty" class="form-control number_of_qty" value="{{ $edit->num_of_item }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
...
<script>
    function getphysicalitem() {
        ...
        var invoice_no = $("#invoice_no").val();
        //alert(invoice);
        $.post('{{ url('get/physicalstckitem/all/') }}/' + invoice_no, {
                _token: '{{ csrf_token() }}'
            },
            function(data) {
                // console.log(data);
...
<script>
    function getphysicalitemqty() {
        ...
        var invoice_no = $("#invoice_no").val();
        //alert(invoice_no);
        $.post('{{ url('get/physicalstckitem/qty/') }}/' + invoice_no, {
                _token: '{{ csrf_token() }}'
            },
            function(data) {
...
<script>
    function cartDatadelete(el) {
        ...
        //alert("ok");
        $.post('{{route('get.phycalstock.delete')}}', {
                _token: '{{ csrf_token() }}',
                item_id: el.value
            },
            function(data) {
...
<script>
    function cartdata(el) {
        ...
        //alert(el.value)
        $.post('{{route('get.physicalstockitem.edit')}}', {
                _token: '{{ csrf_token() }}',
                item_id: el.value
            },
            function(data) {

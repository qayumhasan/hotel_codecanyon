...
@section('title', 'Slow Moving Items | '.$companyinformation->company_name)
@section('content')
@php
...
<div class="content-page">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card p-4">
                    <form id="search_kot_items" action="{{route('admin.restaurant.chui.menu.Kot.slow.moving.search')}}" method="post">

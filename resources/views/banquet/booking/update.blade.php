...
@section('title', 'Booking Create | '.$companyinformation->company_name)
@section('content')
@php
...
<script>
    function getbanquetitem() {
        ...
        var booking_no = $("#booking_no").val();
        //alert(invoice);
        $.post('{{ url('get/banquetitem/all/') }}/' + booking_no, {
                _token: '{{ csrf_token() }}'
            },
            function(data) {
                // console.log(data);
...
<script>
    function cartDatadelete(el) {
        $.post('{{route('get.banquetitem.delete')}}', {
                _token: '{{ csrf_token() }}',
                item_id: el.value
            },
            function(data) {
...
<script>
    function cartdata(el) {
        ...
        //alert(el.value)
        $.post('{{route('get.banquetitem.edit')}}', {
                _token: '{{ csrf_token() }}',
                item_id: el.value
            },
            function(data) {
...
<script>
    function carttax(el) {
        //alert(el.value);
        $.post('{{route('get.banquettax.edit')}}', {
                _token: '{{ csrf_token() }}',
                item_id: el.value
            },
            function(data) {
...
<script>
    function alltax() {
        ...
        var booking_no = $("#booking_no").val();
        //alert(invoice);
        $.post('{{ url('get/banquettax/all/') }}/' + booking_no, {
                _token: '{{ csrf_token() }}'
            },
            function(data) {
...
<script>
    function carttaxdelete(el) {
        $.post('{{route('get.banquettax.delete')}}', {
                _token: '{{ csrf_token() }}',
                item_id: el.value
            },
            function(data) {
...
<script>
    function allcateitem() {
        ...
        var booking_no = $("#booking_no").val();
        //alert(invoice);
        $.post('{{ url('get/allcateitem/all/') }}/' + booking_no, {
                _token: '{{ csrf_token() }}'
            },
            function(data) {
                // console.log(data);
...
<script>
    function categoryitemdelete(el) {
        ...
        // alert("ok");
        $.post('{{route('get.categoryitemdelete.delete')}}', {
                _token: '{{ csrf_token() }}',
                item_id: el.value
            },
            function(data) {
...
<script>
    function allamount() {
        ...
        $.post('{{ route('get.banquet.allamount') }}', {
                _token: '{{ csrf_token() }}',
                booking_no: booking_no,
                total_pax_amount: total_pax_amount
            },
            function(data) {
                // console.log(data);

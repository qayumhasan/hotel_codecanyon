                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>$ {{$row->amount}}</td>
                                <!-- <td> -->
                                <!-- <a class="badge bg-success-light mr-2" data-toggle="tooltip" data-placement="top" href="{{route('admin.checkin.delete.voucher',$row->id)}}" data-original-title="view"> <i class="la la-eye"></i></a>
                                </td> -->
                            </tr>
                            @php

...
@section('title', 'Create Stock Center | '.$seo->meta_title)
@section('content')
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Add Stock Center</h4>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="card shadow-sm shadow-showcase">
                            <div class="card-header d-flex justify-content-between asif">
                                <div class="header-title">
                                    <h4 class="card-title">Stock Center Content</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <form action="{{route('admin.stockcenter.store')}}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="fname">Stock Center Name: *</label>
                                                <input type="text" class="form-control" name="name" placeholder="Stock Center Name" />
                                                @error('name')

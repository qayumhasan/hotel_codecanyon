...
@section('title', 'update StockCenter | '.$seo->meta_title)
@section('content')
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Update StockCenter</h4>
                        </div>
                        <a href="{{route('admin.stockcenter.create')}}"><button class="btn btn-sm bg-primary"><i class="ri-add-fill"><span class="pl-1">Add Stock-Center</span></i></button></a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">

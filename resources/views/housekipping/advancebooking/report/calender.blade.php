...
@section('title', 'Calendar Wise Report | '.$seo->meta_title)
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <form id="search_calender">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control select_room_no" name="room_type">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control select_room_no" name="year">
...
<script>
    ...
    searchbtn.addEventListener('click', function() {  
        ...
        $.ajax({
            type: 'get',
            url: "{{ url('/admin/housekeeping/advance/report/get') }}",

...
@section('title', 'Account MainCategory Create| '.$seo->meta_title)
@section('content')
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Add Account MainCategory</h4>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="card shadow-sm shadow-showcase">
                            ...
                            <div class="card-body">
                            <form action="{{route('admin.account.maincategory.create')}}" method="POST">
                                 @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="fname">ManiCategory Name:*</label>
                                                <input type="text" class="form-control" name="maincategory_name" placeholder="MainCategory Name"/>

                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card shadow-sm shadow-showcase">
                            ...
                            <div class="card-body">
                            <form action="{{route('admin.account.subcategorytwo.store')}}" method="POST">
                                 @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="fname">SubCategory NameTwo:*</label>
                                                <input type="text" class="form-control" name="subcategory_nametwo" placeholder="SubCategory NameTwo"/>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="subcategoryone">
                                                    ...
                                                    <option value="{{$category->id}}">{{$category->subcategory_nameone}}</option>
                                                    @endforeach
                                                </select>

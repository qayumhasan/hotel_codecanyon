               ...
               <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                     ...
                     <div class="iq-text">
                        ...
                        <h3 class="text-white">{{$totalcategores}}</h3>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="card card-block card-stretch card-height bg-warning rounded">
               <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                     ...
                     <div class="iq-text">
                        <h6 class="text-white">Total Main Categories</h6>
                        <h3 class="text-white">{{$totalmaincategores}}</h3>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="card card-block card-stretch card-height bg-success rounded">
               <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                     ...
                     <div class="iq-text">
                        <h6 class="text-white">Total Chart Of Accounts</h6>
                        <h3 class="text-white">{{$totalChartofAccounts}}</h3>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="card card-block card-stretch card-height bg-danger rounded">
               <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                     ...
                     <div class="iq-text">
                        <h6 class="text-white">Total Transitions</h6>
                        <h3 class="text-white">{{$totalTransitions}}</h3>
                     </div>
                  </div>
               </div>
            </div>
